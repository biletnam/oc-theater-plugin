...
class Plugin extends PluginBase
{
            ...
            'theater' => [
                ...
                'sideMenu' => [
                    ...
                    'backgrounds'  => [
                        'label' => 'Фоны',
                        'icon'  => 'icon-ticket',
                        'url'   => \Backend::url('abnmt/theater/backgrounds'),
                    ],
                ],
            ],
        ];
    ...
    public function registerComponents()
    {
        return [
            ...
            'Abnmt\Theater\Components\Backgrounds' => 'theaterBackgrounds',
        ];
    }
    ...
    public static function dateLocale($dateString, $dateFormat = '%c')
    {
        ...
        if ($dateFormat === '%c') {
            $dateFormat = Lang::get('abnmt.theater::lang.dates.dateFormat');
        }
